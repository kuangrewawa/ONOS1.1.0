 ...
 */
package org.onosproject.app.vtnrsc.cli.virtualport;
 ...
 */
@Command(scope = "onos", name = "virtualPort-remove", description = "Supports for removing a virtualPort.")
public class VirtualPortRemoveCommand extends AbstractShellCommand {
    ...
    @Argument(index = 9, name = "fixedIp", description = " a IP address for the port,Include the IP addressand "
    ...
    protected void execute() {
        ...
        VirtualPort virtualPort = new DefaultVirtualPort(
                                                         ...
                                                         allowedAddressPairs,
                                                         securityGroups);
        Set<VirtualPortId> virtualPorts = new HashSet<VirtualPortId>();
