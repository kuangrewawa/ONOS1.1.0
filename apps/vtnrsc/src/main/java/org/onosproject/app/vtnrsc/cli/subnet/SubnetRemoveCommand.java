 ...
 */
@Command(scope = "onos", name = "remove-subnet", description = "Supports for removing subnets")
public class SubnetRemoveCommand extends AbstractShellCommand {
    ...
    protected void execute() {
        ...
        Subnet subnet = new DefaultSubnet(
                                          SubnetId.subnetId(id), subnetName,
                                          ...
                                          Mode.valueOf(ipV6AddressMode),
                                          Mode.valueOf(ipV6RaMode),
                                          allocationPools);
        Set<SubnetId> subnetsSet = new HashSet<SubnetId>();
